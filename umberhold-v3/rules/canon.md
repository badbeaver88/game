...
This file does **not** modify `DESIGN.md`.
...
- `rules/monster-stat-block-canon.md`
...
- `rules/weapon-statistics-canon.md`
...
- the current cantrip and 1st-level spell list is tracked in `spells/spells-cantrips-1st.md`
...
- detailed condition behavior is tracked in `rules/conditions-canon.md`

### Monster Stat Block Rules
- the generic monster stat block is tracked in `rules/monster-stat-block-canon.md`
- monsters use Level rather than challenge rating
- current monster levels are 1-20
...
### Experience Rules
- the current experience rules are tracked in `rules/experience-canon.md`
- monsters award XP based on monster level
- XP is shared equally among surviving party members
- leveling up is performed at an inn
- leveling up has no gold cost
...
- the current currency rules are tracked in `rules/currency-canon.md`
- the current gemstone reference is tracked in `items/gemstones.md`
- Silver Rook is the base coin
- Gold Crown is worth 10 Silver Rooks
- Platinum Stag is worth 25 Gold Crowns

### Mundane Equipment Rules
- the current mundane equipment sheet is tracked in `rules/mundane-equipment-canon.md`
- mundane settlement stock is divided between equipment shops and temples
- food and arrows are not tracked
- holy water deals `2d6` holy damage to undead only
- flasks of oil deal `2d4` fire damage on hit and apply Burning for `1d4` fire damage at the start of the target's next turn
...
- the current class hit-die and equipment rules are tracked in `rules/class-equipment-canon.md`
- each class has a defined hit die per level
- Constitution modifier is added to each hit point roll
- every level requires a hit point roll
- armor restrictions are absolute
...
### Weapon Rules
- the current weapon table is tracked in `rules/weapon-statistics-canon.md`
- weapon entries include damage type
- weapon entries include range values from 1-3
- Quarterstaff is part of the approved weapon table
- finesse weapons may use Strength or Agility, whichever is higher
...
- `rules/combat-turn-canon.md`
- `rules/damage-canon.md`
- `rules/spellcasting-canon.md`
- `spells/spells-cantrips-1st.md`
- `spells/class-spell-lists.md`
- `rules/conditions-canon.md`
- `rules/monster-stat-block-canon.md`
- `rules/experience-canon.md`
- `rules/currency-canon.md`
