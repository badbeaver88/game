...
### Exploration MVP
- 1 region: **Umberhold / Gravenhold Manor**
- 1 full **26x26** map
...
- `schemas/time/world-clock-state.schema.json`
- `schemas/time/day-phases.schema.json`
- `schemas/time/service-schedules.schema.json`
- `schemas/time/timed-effects.schema.json`
...
### Deliverable
A player can walk through Gravenhold Manor, turn corners, trigger events, find loot, and enter combat.
...
7. Produce a **Gravenhold vertical slice** before expanding to more regions.
...
Start by making **Gravenhold Manor** excellent. If the opening village, the first dungeon grid, and the first boss are atmospheric and mechanically sharp, the rest of Umberhold can scale from a strong foundation.
