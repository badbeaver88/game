...
- Use `templates/monster-template.md` for new monster entries.
- Core monster rules are tracked in `rules/monster-stat-block-canon.md`.
- XP rules are tracked in `rules/experience-canon.md`.
