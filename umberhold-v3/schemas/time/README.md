...
- `examples/time/world-clock-state.example.json`
- `examples/time/day-phases.example.json`
- `examples/time/service-schedules.example.json`
- `examples/time/timed-effects.example.json`
